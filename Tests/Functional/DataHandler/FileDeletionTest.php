...
/**
  * Description
  */
class FileDeletionTest extends FunctionalTestCase {
     ...
     * @var string
     */
    protected $scenarioDataSetDirectory = 'typo3conf/ext/file_variants/Tests/Functional/DataHandler/DataSet/FileDeletion/Initial/';

    /**
     * @var string
     */
    protected $assertionDataSetDirectory = 'typo3conf/ext/file_variants/Tests/Functional/DataHandler/DataSet/FileDeletion/AfterOperation/';
     ...
     * @test
     */
    public function deletionOfLanguageVariantResetsReferencesToUseDefaultLanguageFile()
    {
        $scenarioName = 'ConnectedMode_DeleteLanguageVariant';
