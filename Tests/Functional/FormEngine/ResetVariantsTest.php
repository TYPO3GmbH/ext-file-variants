...
namespace T3G\AgencyPack\FileVariants\Tests\Functional\FormEngine;
/*
...
class ResetVariants extends FunctionalTestCase
{
    /**
     * @var int
     */
     ...
     * @var string
     */
    protected $scenarioDataSetDirectory = 'typo3conf/ext/file_variants/Tests/Functional/FormEngine/DataSet/Initial/';

    /**
     * @var string
     */
    protected $assertionDataSetDirectory = 'typo3conf/ext/file_variants/Tests/Functional/FormEngine/DataSet/AfterOperation/';
...
//        unset($GLOBALS['TCA']['tt_content']['columns']['image']['config']['filter']);
    ...
    protected function cleanUpFilesAndRelatedRecords() {
        ...
        foreach ($recordsToDelete as $table => $uids) {
     ...
     * @test
     */
    public function resetVariantChangesFileRecordButNotReferences() {
        $scenarioName = 'ResetVariant';
        ...
        copy(PATH_site .'typo3conf/ext/file_variants/Tests/Fixture/TestFiles/business_1.jpg', PATH_site . 'languageVariants/languageVariants/business_1.jpg');

        $persistenceService = new PersistenceService();
        $recordService = new RecordService($persistenceService);
        $referenceRecordService = new ReferenceRecordService($persistenceService, $recordService);
        $subject = new FileRecordService($persistenceService, $referenceRecordService);
        $subject->replaceVariantWithDefaultFile(2);
